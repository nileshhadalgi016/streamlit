...
const useTimeoutRestrictedGlobals = [
  {
    name: "setTimeout",
    message:
      "Please use the `useTimeout` hook instead of direct `setTimeout` in components and hooks.",
  },
]
...
const useTimeoutRestrictedProperties = [
  {
    ...
    property: "setTimeout",
    message:
      "Please use the `useTimeout` hook instead of `window.setTimeout` in components and hooks.",
  },
  {
    object: "globalThis",
    property: "setTimeout",
    message:
      "Please use the `useTimeout` hook instead of `globalThis.setTimeout` in components and hooks.",
  },
]
